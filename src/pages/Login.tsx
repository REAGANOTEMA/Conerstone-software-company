...
const Login = () => {
  ...
  const handleLogin = (e: React.FormEvent, role: any, specificEmail?: string) => {
    e.preventDefault();
    const loginEmail = specificEmail || email;
    const success = login(loginEmail, password || 'password123', role);
            ...
            <Tabs defaultValue="director" className="w-full">
              ...
              <TabsContent value="client">
                <form onSubmit={(e) => handleLogin(e, 'client')} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="client-id">Client ID / Email</Label>
                    <Input 
                      id="client-id" 
                      type="email"
                  ...
                  <Button 
                    type="submit"
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white h-11 mt-4"
                  >
